...
const rankingInfo = () => {
  ...
  const colors = ['yellow', 'orange', 'purple_thr', 'sky_blue', 'green', 'blue', 'stone-500'];
              ...
              <div className='grid grid-cols-3 gap-16 w-full'>
                <article className='col-span-2 rounded-12 border-1 border-gray_60 overflow-hidden'>
                  ...
                  <div className='pl-24 py-12 pb-49 text-14 bg-gray_40 flex flex-col'>
                    ...
                    {scores.map((item, index) => (
                      <div className='flex items-center mt-22' key={item}>
                        <div
                          className={`justify-center flex items-center gap-27 w-52 h-52 rounded-26 border border-${colors[index]} bg-${colors[index]}/[0.1] mr-47`}
                        >
                          <span className={`text-23 font-bold text-${colors[index]}`}>{ranks[index]}</span>
                        </div>
                        <span className={`text-${colors[index]}`}>{scores[index]}</span>
                      </div>
                    ))}
                  </div>
                </article>
                <article className='col-span-1 rounded-12 border-1 border-gray_60 overflow-hidden'>
                  <div className='px-16 py-12 text-14 bg-gray_40 flex flex-col'>
                    ...
                    <div className='flex items-center text-blue mt-16 mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 출석체크 +5점
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5 '></div> 피드백 + 5점
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 피드백 + 5점
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 매 회차 성실도 피드백 평균 점수에 따라
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-1 ml-20 mr-5'></div> 평균 점수 5점 이상 +20점
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-1 ml-20 mr-5'></div> 평균 점수 3점 이상 4점 미만 + 0점
                    </div>

                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 스터디 완주 시 +100점
                    </div>

                    <div className='mt-12'>[이럴 때 등급이 내려가요]</div>
                    <div className='flex items-center text-blue mt-16 mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 1 out -30점
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 스터디 방출 -200점 (출석, 상세규칙)
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 피드백 미완료 -20점
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 매 회차 성실도 피드백 평균 점수에 따라
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-1 ml-20 mr-5'></div> 평균 점수 2점 미만 -20점
                    </div>
                    <div className='mt-12'>Default 규칙</div>
                    <div className='flex items-center text-blue mt-16 mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 결석 1번이면 1 out
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 지각 2번 = 결석 1번 = 1 out
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div> 상세 규칙 불이행 시 1 out
                    </div>
                    <div className='flex items-center text-blue mb-4'>
                      <div className='bg-blue w-5 h-5 rounded-3 mr-5'></div>⚠️ 3 out 시 스터디 자동 퇴출
                    </div>
                  </div>
                </article>
              </div>
